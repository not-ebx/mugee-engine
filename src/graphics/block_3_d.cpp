...
namespace Graphics {
    std::vector<PosTexVertex> getBlockVertices(TextureRegion &region) {
        ...
        std::vector<PosTexVertex> vertices = {
                // Front face
                {-1.0f, -1.0f, 1.0f, packRgba(255, 255, 255, 255), u0, v0},// Bottom-left
                {1.0f, -1.0f, 1.0f, packRgba(255, 255, 255, 255), u1, v0}, // Bottom-right
                {1.0f, 1.0f, 1.0f, packRgba(255, 255, 255, 255), u1, v1},  // Top-right
                {-1.0f, 1.0f, 1.0f, packRgba(255, 255, 255, 255), u0, v1}, // Top-left

                // Back face
                {1.0f, -1.0f, -1.0f, packRgba(255, 255, 255, 255), u0, v0}, // Bottom-right
                {-1.0f, -1.0f, -1.0f, packRgba(255, 255, 255, 255), u1, v0},// Bottom-left
                ...
                // Left face
                {-1.0f, -1.0f, -1.0f, packRgba(255, 255, 255, 255), u0, v0},// Bottom-back
                {-1.0f, -1.0f, 1.0f, packRgba(255, 255, 255, 255), u1, v0}, // Bottom-front
